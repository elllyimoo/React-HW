...
// import {SET_ID_OF_ACTIVE_PRODUCT} from "../../store/product/types";
import {toggleFavorite} from "../../store/products/actions";
// import {TOGGLE_FAVORITE} from "../../store/productList/types";
...
const Product = (props) => {
    ...
    const whatIsActiveProduct = (id) => {
        ...
        // dispatch({type: SET_ID_OF_ACTIVE_PRODUCT, payload: id})
    }
