import {
    ...
    TOGGLE_FAVORITE,
    ADD_TO_CART, REMOVE_FROM_CART, REMOVE_ALL_FROM_CART
} from "./types";
...
const reducer = (state = initialState, action) => {
    switch (action.type) {
        ...
        case REMOVE_ALL_FROM_CART:
            const updateProductsRemoveAllFromCart =  state.products.map(el => {
                if (el.isAddedToCart) {
                    el.isAddedToCart = false;
                    el.quantityOfProduct = 0;
                }
            ...
            return {...state, products: updateProductsRemoveAllFromCart}
